...
<?php
    if(isset($_POST['name']))
    {
        ...
        $e=$_POST['email'];
        $p=$_POST['phone'];
        $sql ="UPDATE User SET Name='".$n."',Password='".$pass."',Email='".$e."',Phone='".$p."' 
    ...
    {
        $sql ="SELECT * FROM User WHERE Id='".$i."' ";  // sql command
        mysqli_select_db($conn,$dbname); //select database as default
        $result=mysqli_query($conn,$sql);  // command allow sql cmd to be sent to mysql
        $rowcat=mysqli_fetch_assoc($result);
        $n=$rowcat['Name'];
        $pass=$rowcat['Password'];
        $e=$rowcat['Email'];
        $p=$rowcat['Phone'];
    }
?>
  ...
  <div class="main main-raised">
    <div class="profile-content">
      <div class="container">
        ...
        <div class="choice">
        <form action="updateUser.php?ID=<?php echo $rowcat['ID'] ?>" method="post">
            <table>
                <tr>
                    <td width="70"><label for="ID" width="50">ID: </label></td>
                    <td><input disabled type="text" name="ID" id="ID" value="<?php echo $i?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="email" name="email" id="email" value="<?php echo $e?>"></td>
                </tr>
                <tr>
                    <td width="70"><label for="phone">Phone: </label></td>
                    <td><input type="tel" name="phone" id="phone" value="<?php echo $p?>"></td>
                </tr>
                <tr>
